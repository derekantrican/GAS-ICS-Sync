...
var overrideVisibility = false;           // Changes the visibility of the event ("default", "public", "private"). Anything else will revert to the class value of the ICAL event.
var addTasks = false;
