...
var removeEventsFromCalendar = true;   // If you turn this to "true", any event created by the script that is not found in the feed will be removed (if onlyFutureEvents is true past events will also be removed)
